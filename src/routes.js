...
const Chequestatussummary = React.lazy(() => import('./views/chequeSystem/chequestatussummary/Chequestatussummary')) 
...
const routes = [
  ...
  { path: '/cheque/chequestatussummary', name: 'Cheque status summary', element: Chequestatussummary },
]
